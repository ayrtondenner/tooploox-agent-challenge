...
```bash
INIT=$(node "C:/Users/Ayrton/Documents/Gitprojects/tooploox-agent-challenge/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/Ayrton/Documents/Gitprojects/tooploox-agent-challenge/.claude/get-shit-done/templates/spec.md.

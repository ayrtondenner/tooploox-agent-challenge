...
```
Task(
  prompt="Read C:/Users/Ayrton/Documents/Gitprojects/tooploox-agent-challenge/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Ayrton/Documents/Gitprojects/tooploox-agent-challenge/.claude/get-shit-done/templates/VALIDATION.md`
